...
python inference.py --model_name text2video_zero --prompts_path prompts/contradicting_occlusion_pairs.csv --output_dir /homes/55/runjia/scratch/gen_video_results --motion_type occlusion
...
python inference.py --model_name animate_lcm --prompts_path prompts/contradicting_occlusion_pairs.csv --output_dir /homes/55/runjia/scratch/gen_video_results --motion_type occlusion
...
python inference.py --model_name modelscope --prompts_path prompts/contradicting_occlusion_pairs.csv --output_dir /homes/55/runjia/scratch/gen_video_results --motion_type occlusion
...
python inference.py --model_name zeroscope --prompts_path prompts/contradicting_occlusion_pairs.csv --output_dir /homes/55/runjia/scratch/gen_video_results --motion_type occlusion
...
python inference.py --model_name animate_diff --prompts_path prompts/contradicting_occlusion_pairs.csv --output_dir /homes/55/runjia/scratch/gen_video_results --motion_type occlusion
